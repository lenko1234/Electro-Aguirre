...
export const catalogoItemType = defineType({
    ...
    fields: [
        ...
        defineField({
            ...
            options: {
                list: [
                    ...
                    { title: 'Herramientas', value: 'Herramientas' },
                    { title: 'UNI-T', value: 'UNI-T' },
                    { title: 'Jadever', value: 'Jadever' },
                    { title: 'FullEnergy', value: 'FullEnergy' },
                    { title: 'Viyilant', value: 'Viyilant' },
                    { title: 'Baw', value: 'Baw' },
                    { title: 'Kalop', value: 'Kalop' },
                    { title: 'Bulit', value: 'Bulit' },
                    { title: 'GRALF', value: 'GRALF' },
        ...
        defineField({
            ...
            options: {
                list: [
                    { title: 'Lámparas de techo', value: 'Lámparas de techo' },
                    { title: 'Lámparas de pared', value: 'Lámparas de pared' },
                    { title: 'Lámparas de pie', value: 'Lámparas de pie' },
                    { title: 'Lámparas de escritorio', value: 'Lámparas de escritorio' },
                    { title: 'Lámparas de exterior', value: 'Lámparas de exterior' },
                    { title: 'Veladores y Pantallas', value: 'Veladores y Pantallas' },
                    { title: 'Focos', value: 'Focos' },
                    { title: 'Rieles', value: 'Rieles' },
